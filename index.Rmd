...
icono_activos <- 'fas fa-head-side-virus'
icono_recuperados <- 'fas fa-virus-slash'
icono_fallecidos <- 'fas fa-skull-crossbones'
...
paleta_fallecidos <- colorBin(palette = "Pink", 
