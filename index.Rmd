...
author: "ING. Juan Miguel Víquez R"
output: 
...
color_salon <- 'lightgreen'
color_uci <- 'brown'

#--------------------- Íconos ---------------------

icono_positivos <- 'fas fa-user-md'
icono_activos <- "fas fa-bed"
icono_recuperados <- 'fas fa-briefcase-medical'
...
=======================================================================
  Row {data-height=10}
-----------------------------------------------------------------------
### **Última actualización de datos realizada el `r  df_general_pais_ultima_fecha$FECHA` **.
...
paletapositivos <- colorBin(palette = "Blues", 
                              domain = sf_positivos_cantones_ultima_fecha$positivos,
                              bins = 10
)

leaflet_cantones_positivos <- leaflet(sf_positivos_cantones_ultima_fecha) %>% 
  fitBounds(lng1 = -86, lng2 = -82, lat1 = 8, lat2 = 11) %>%
  addProviderTiles(providers$OpenStreetMap.Mapnik, group = "OpenStreetMap") %>%
  addPolygons(fillColor = ~paletapositivos(positivos), stroke=T, fillOpacity = 1,
              ...
              popup = paste("Provincia: ", sf_positivos_cantones_ultima_fecha$provincia, "<br>",
                            ...
                            "Activos: ", sf_positivos_cantones_ultima_fecha$positivos
              )
  ) %>%
  addLegend("bottomright", pal = paletapositivos, values = ~positivos,
...
paletaactivos <- colorBin(palette = "Reds", 
...
leaflet_cantones_activos <- leaflet(sf_activos_cantones_ultima_fecha) %>% 
  fitBounds(lng1 = -86, lng2 = -82, lat1 = 8, lat2 = 11) %>%
  addProviderTiles(providers$OpenStreetMap.Mapnik, group = "OpenStreetMap") %>%
  addPolygons(fillColor = ~paletaactivos(activos), stroke=T, fillOpacity = 1,
              color="black", weight=0.2, opacity= 0.5,
              group = "Cantones",
  ...
  addLegend("bottomright", pal = paletaactivos, values = ~activos,
            title = "Casos activos",
            opacity = 1
  ) %>%  
  addLayersControl(
...
paletarecuperados <- colorBin(palette = "Greens", 
...
leaflet_cantones_recuperados <- leaflet(sf_recuperados_cantones_ultima_fecha) %>% 
  fitBounds(lng1 = -86, lng2 = -82, lat1 = 8, lat2 = 11) %>%
  addProviderTiles(providers$OpenStreetMap.Mapnik, group = "OpenStreetMap") %>%
  addPolygons(fillColor = ~paletarecuperados(recuperados), stroke=T, fillOpacity = 1,
              color="black", weight=0.2, opacity= 0.5,
              group = "Cantones",
              popup = paste("Provincia: ", sf_recuperados_cantones_ultima_fecha$provincia, "<br>",
                            ...
                            "Fallecidos: ", sf_recuperados_cantones_ultima_fecha$recuperados
              )
  ) %>%
  addLegend("bottomright", pal = paletarecuperados, values = ~recuperados,
...
paletafallecidos <- colorBin(palette = "Purples", 
                              domain = sf_fallecidos_cantones_ultima_fecha$fallecidos,
                              bins = 9
)

leaflet_cantones_fallecidos <- leaflet(sf_fallecidos_cantones_ultima_fecha) %>% 
  fitBounds(lng1 = -86, lng2 = -82, lat1 = 8, lat2 = 11) %>%
  addProviderTiles(providers$OpenStreetMap.Mapnik, group = "OpenStreetMap") %>%
  addPolygons(fillColor = ~paletafallecidos(fallecidos), stroke=T, fillOpacity = 1,
              color="black", weight=0.2, opacity= 0.5,
              group = "Cantones",
  ...
  addLegend("bottomright", pal = paletafallecidos, values = ~fallecidos,
